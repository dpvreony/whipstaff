...
{
    /// <summary>
    /// Registration details for a view model that is registered as a constant.
    /// </summary>
    ...
    public sealed class ConstantViewModelRegistration<TViewModel> : IConstantViewModelRegistration
        where TViewModel : class, IReactiveObject, new()
    {
        ...
        public void Register(IReactiveUIBuilder reactiveUiBuilder)
        {
            ...
            _ = reactiveUiBuilder.RegisterConstantViewModel<TViewModel>();
        }
    }
}
