...
namespace Whipstaff.UnitTests.Mediator.EntityFrameworkCore
{
    /// <summary>
    /// Unit Tests for the Functional class to fetch an entity for a Mediator request based on an id that is an int32.
    /// </summary>
