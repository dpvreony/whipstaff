...
{
    /// <summary>
    /// A <see cref="ContentControl"/> that is reactive.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This class is a <see cref="ContentControl"/> that is also reactive. That is, it implements <see cref="IViewFor{TViewModel}"/>.
    ...
    /// <code>
    /// <![CDATA[
    /// <whipstaffWpf:ReactiveContentControl
    ...
    /// </typeparam>
    public class ReactiveContentControl<TViewModel> : ContentControl, IViewFor<TViewModel>
...
#pragma warning restore RCS1158 // Static member in generic type should use a type parameter.
            DependencyProperty.Register(
                nameof(ViewModel),
                typeof(TViewModel),
                typeof(ReactiveContentControl<TViewModel>),
