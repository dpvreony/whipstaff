...
namespace Whipstaff.Core.Logging
{
    ...
    public static class WhipstaffEventIdFactory
    {
        ...
        /// <summary>
        /// Gets the Event Id for the No Mediator Handlers Registered for type logging event.
        /// </summary>
        /// <returns>Event Id.</returns>
        public static EventId NoMediatorHandlersRegisteredForTypeEventId() => new(2, "No Mediator Handlers Registered for type");

        /// <summary>
        /// Gets the Event Id for the Number of Mediator Handlers Registered for type logging event.
        /// </summary>
        /// <returns>Event Id.</returns>
        public static EventId CountOfMediatorHandlersRegisteredEventId() => new(3, "Number of Mediator Handlers Registered for type");
