...
{
    /// <summary>
    /// A <see cref="ChildWindow"/> that is reactive.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This class is a <see cref="ChildWindow"/> that is also reactive. That is, it implements <see cref="IViewFor{TViewModel}"/>.
    ...
    /// </typeparam>
    public class ReactiveSimpleChildWindow<TViewModel> : ChildWindow, IViewFor<TViewModel>
